...
import static seedu.nova.model.addressbook.AddressBookModel.PREDICATE_SHOW_ALL_PERSONS;
...
public class EditCommand extends Command {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        List<Person> lastShownList = model.getAddressBook().getFilteredPersonList();
        ...
        if (!personToEdit.isSamePerson(editedPerson) && model.getAddressBook().hasPerson(editedPerson)) {
            throw new CommandException(MESSAGE_DUPLICATE_PERSON);
        }

        model.getAddressBook().setPerson(personToEdit, editedPerson);
        model.getAddressBook().updateFilteredPersonList(PREDICATE_SHOW_ALL_PERSONS);
