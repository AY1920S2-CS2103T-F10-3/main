...
+
image::userguide/addressbooklist.png[width="790" align="center"]
[.text-center]
...
+
image::userguide/addressbookadd.png[width="790" align="center"]
[.text-center]
...
image::userguide/addressbook.png[width="790" align="center"]
[.text-center]
_[.small]#Fig 5.1.2: GUI of NOVA after entering `nav ab`#_
...
Example: +
Suppose you want to add your classmate named Jane Doe, with phone number 98765432 and email address john@gmail.com
into NOVA,

`add n\John Doe p\98765432 e\\john@gmail.com c\classmate`

NOVA will add a new contact named John Doe, phone number 98765432 and email address john@gmail.com into the
classmate category as seen below.

image::userguide/addressbookadd.png[width="790" align="center"]
[.text-center]
_[.small]#Fig 5.2.1: GUI of NOVA after user typed contact `add n\John Doe p\98765432 e\\john@gmail.com c\classmate`#_
...
image::userguide/addressbooklist.png[width="790" align="center"]
[.text-center]
_[.small]#Fig 5.2.2: GUI of NOVA after user typed contact `list`#_
...
+
image::userguide/addressbooklistclassmate.png[width="790" align="center"]
[.text-center]
_[.small]#Fig 5.2: GUI of NOVA after user typed contact `list c\classmate`#_
+
...
+
image::userguide/addressbooklistteammate.png[width="790" align="center"]
[.text-center]
_[.small]#Fig 5.2: GUI of NOVA after user typed contact `list c\teammate`#_
+
<<Top, [Back to Top]>>
...
image::userguide/addressbookfind.png[width="790" align="center"]
[.text-center]
_[.small]#Fig 5.2: GUI of NOVA after user typed contact `find n\Jane doe`#_

* Or you can find Jane Doe with just Doe,
+
`find n\Doe`
+
NOVA will find and list saved contacts named Doe.

image::userguide/addressbookfinddoe.png[width="790" align="center"]
[.text-center]
_[.small]#Fig 5.2: GUI of NOVA after user typed contact `find n\Doe`#_
...
image::userguide/addressbookremark.png[width="790" align="center"]
[.text-center]
_[.small]#Fig 5.2: GUI of NOVA after user typed contact `remark i\1 r\He's a nice teammate`#_
...
image::userguide/addressbookdelete.png[width="790" align="center"]
[.text-center]
_[.small]#Fig 5.2: GUI of NOVA after user typed contact `delete i\1`#_
...
image::userguide/addressbookclear.png[width="790" align="center"]
[.text-center]
_[.small]#Fig 5.2: GUI of NOVA after user typed contact `clear`#_
...
image::userguide/addressbookundo.png[width="790" align="center"]
[.text-center]
_[.small]#Fig 5.2: GUI of NOVA after user typed contact `undo`#_
...
image::userguide/addressbookredo.png[width="790" align="center"]
[.text-center]
_[.small]#Fig 5.2: GUI of NOVA after user typed contact `redo`#_
